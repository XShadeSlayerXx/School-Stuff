...
# TODO: add custom output array sizes
#  and custom inputs (e.g. the output of the input array...?)
#  Maybe custom error correction, so output error can backpropagage to input stuff.
